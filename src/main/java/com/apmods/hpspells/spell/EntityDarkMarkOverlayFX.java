...
public class EntityDarkMarkOverlayFX extends EntityFX
{
    private static final String __OBFID = "CL_00000904";

    protected EntityDarkMarkOverlayFX(World p_i1206_1_, double p_i1206_2_, double p_i1206_4_, double p_i1206_6_)
    {

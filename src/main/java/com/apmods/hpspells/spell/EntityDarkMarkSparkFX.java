...
public class EntityDarkMarkSparkFX extends EntityFX
{
    ...
    public EntityDarkMarkSparkFX(World p_i1207_1_, double p_i1207_2_, double p_i1207_4_, double p_i1207_6_, double p_i1207_8_, double p_i1207_10_, double p_i1207_12_, EffectRenderer p_i1207_14_)
    {
    ...
    public void onUpdate()
    {
        ...
        {
            EntityDarkMarkSparkFX entityfireworksparkfx = new EntityDarkMarkSparkFX(this.worldObj, this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D, this.field_92047_az);

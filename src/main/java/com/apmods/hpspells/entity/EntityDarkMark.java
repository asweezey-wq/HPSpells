...
import com.apmods.hpspells.spell.EntityDarkMarkFX;
...
public class EntityDarkMark extends Entity
{
    ...
    public EntityDarkMark(World p_i1762_1_)
    {
        super(p_i1762_1_);
    ...
    public EntityDarkMark(World p_i1763_1_, double p_i1763_2_, double p_i1763_4_, double p_i1763_6_)
    {
        super(p_i1763_1_);
        this.fireworkAge = 0;
        this.setSize(0.25F, 0.25F);
        ...
        this.motionY = 0.05D;
        this.lifetime = 10 + rand.nextInt(6);
    }
    ...
    public void onUpdate()
    {
		...
		this.worldObj.playSound(this.posX, this.posY, this.posZ, "mob.enderdragon.growl", 20.0F, 0.95F + this.rand.nextFloat() * 0.1F, true);
    ...
    public void handleHealthUpdate(byte p_70103_1_)
    {
        if (p_70103_1_ == 17 && this.worldObj.isRemote)
        {
            ...
            if(this.worldObj.isRemote){
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityDarkMarkFX(worldObj, this.posX, this.posY, this.posZ, this.motionX, this.motionY, this.motionZ, Minecraft.getMinecraft().effectRenderer));
            }
        }

...
public class GuiImperio extends InventoryEffectRenderer
{
    ...
    public GuiImperio(EntityPlayer p_i1094_1_)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        func_147046_a(k + 51, l + 75, 30, (float)(k + 51) - this.xSizeFloat, (float)(l + 75 - 50) - this.ySizeFloat, player);
    }
